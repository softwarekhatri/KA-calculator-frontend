            ...
            {variants.length > 0 ? (
              ...
              <tr>
                <td colSpan={5} className="text-center py-4 text-slate-400">
                  No {capitalize(metalType)} variants added yet.
                </td>
              </tr>
            )}
          </tbody>
...
interface ConfigSectionProps {
  goldPrice: IPriceData;
  setGoldPrice: (type: metalType, price: number) => void;
  silverPrice: IPriceData;
...
const ConfigSection: React.FC<ConfigSectionProps> = (props) => {
  ...
  const handleExport = () => {
    const config = {
      goldPrice: props.goldPrice.price,
      silverPrice: props.silverPrice.price,
    ...
    reader.onload = (e) => {
      try {
        ...
        if (
          ...
          props.setGoldPrice("GOLD", importedConfig.goldPrice);
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                placeholder="7000"
                value={props.goldPrice?.price}
                onChange={(e) =>
                  props.setGoldPrice("GOLD", parseFloat(e.target.value) || 0)
                }
